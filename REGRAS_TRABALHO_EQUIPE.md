...
5. Executo o Checklist de Verificação (obrigatório antes de todo commit)
6. Sugiro commit e espero autorização
7. Após autorização, forneço comandos git
8. Se quiser PR, forneço os comandos completos
```
