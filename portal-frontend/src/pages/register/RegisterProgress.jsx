...
const RegisterProgress = ({ step, stepConfig }) => (
        ...
        <div style={{ textAlign: 'center' }}>
          <div
            ...
            style={{
              ...
              width: step === s.num ? '2.5rem' : '2rem', height: '2rem',
          ...
          <span
            ...
            style={{ fontSize: '0.6875rem', marginTop: '0.375rem', display: 'block', whiteSpace: 'nowrap' }}
          >
            {s.label}
          </span>
        </div>
