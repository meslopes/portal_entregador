...
import {
  ...
  Edit, Plus, Trash2, BarChart3, Shield
} from 'lucide-react';
import api from '@/lib/api';
import { showToast } from '@/components/Toast';
import TrashModal from '@/components/TrashModal';
import { OverviewTab, TenantsTab, UsersTab, PendingTab } from './platform-tabs';
      ...
      {editingTenant && (
        <>
          ...
          <div style={{
            ...
            <form onSubmit={handleUpdateTenant} style={{ padding: '1.5rem' }}>
              <div style={{ marginBottom: '1rem' }}>
                ...
                <input
                  ...
                  onChange={(e) => setTenantEditForm(prev => ({ ...prev, name: e.target.value }))}
              ...
              <div style={{ marginBottom: '1rem' }}>
                ...
                <input
                  ...
                  onChange={(e) => setTenantEditForm(prev => ({ ...prev, slug: e.target.value.toLowerCase().replace(/\s+/g, '-') }))}
                  style={{ width: '100%', padding: '0.625rem 0.875rem', borderRadius: '0.5rem', border: '1.5px solid #e2e8f0', fontSize: '0.875rem', outline: 'none', boxSizing: 'border-box' }}
                />
              </div>
              ...
              <div style={{ marginBottom: '1rem' }}>
                ...
                <select
                  ...
                  onChange={(e) => setTenantEditForm(prev => ({ ...prev, plan: e.target.value }))}
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', marginBottom: '1rem' }}>
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setTenantEditForm(prev => ({ ...prev, phone: e.target.value }))}
                    style={{ width: '100%', padding: '0.625rem 0.875rem', borderRadius: '0.5rem', border: '1.5px solid #e2e8f0', fontSize: '0.875rem', outline: 'none', boxSizing: 'border-box' }}
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setTenantEditForm(prev => ({ ...prev, cnpj: e.target.value }))}
                    style={{ width: '100%', padding: '0.625rem 0.875rem', borderRadius: '0.5rem', border: '1.5px solid #e2e8f0', fontSize: '0.875rem', outline: 'none', boxSizing: 'border-box' }}
                  />
                </div>
              </div>
                ...
                <div>
                  ...
                  <div style={{ display: 'flex', gap: '0.5rem', alignItems: 'center' }}>
                    <input
                      ...
                      onChange={(e) => setTenantEditForm(prev => ({ ...prev, primary_color: e.target.value }))}
                ...
                <div>
                  ...
                  <div style={{ display: 'flex', gap: '0.5rem', alignItems: 'center' }}>
                    <input
                      ...
                      onChange={(e) => setTenantEditForm(prev => ({ ...prev, secondary_color: e.target.value }))}
                      style={{ width: '40px', height: '36px', border: 'none', borderRadius: '0.375rem', cursor: 'pointer' }}
                    />
                    <input
                      type="text"
