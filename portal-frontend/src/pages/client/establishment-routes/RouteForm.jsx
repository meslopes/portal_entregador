...
const RouteForm = ({ orders, selectedOrders, onToggleOrder, onClose, onSubmit, loading }) => {
  return (
          ...
          <div style={{ display: 'flex', gap: '0.75rem', justifyContent: 'flex-end' }}>
            ...
            <button
              ...
              style={{
                ...
                borderRadius: '0.5rem',
                border: 'none',
                background: loading || selectedOrders.length === 0 ? '#94a3b8' : '#2563eb',
                color: 'white',
                fontSize: '0.875rem',
                fontWeight: 600,
                cursor: loading || selectedOrders.length === 0 ? 'not-allowed' : 'pointer'
              }}
            >
