...
const OrdersPage = () => {
  ...
  // Atualiza a lista de pedidos periodicamente (30 segundos para nao sobrecarregar)
  useEffect(() => {
    loadAvailableOrders();
    loadActiveOrders();
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem', flexWrap: 'wrap', gap: '1rem' }}>
        <div>
          ...
          <p style={{ color: '#64748b', fontSize: '0.9375rem' }}>
            ...
            {!isLoading && <span style={{ fontSize: '0.75rem', color: '#94a3b8', marginLeft: '0.5rem' }}>• atualiza a cada 30s</span>}
          </p>
        </div>
